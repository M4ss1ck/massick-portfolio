      ...
      <ul className="languages">
        {languages.map(lng => (
          <li
            ...
            className={
              language === lng
                ? "text-center text-sm lg:text-lg py-4 font-montserrat cursor-pointer outline outline-secundario outline-1 text-gray-900 dark:text-secundario  inline-flex items-center px-2 pt-2 pb-2 font-medium leading-5 transition duration-250 ease-in-out mx-2"
