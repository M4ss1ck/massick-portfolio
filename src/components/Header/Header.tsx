...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 w-full px-4 pt-4 pb-0 md:pt-2 bg-gradient-to-r from-white via-transparent to-white dark:from-black dark:via-gray-900 dark:to-black dark:text-white">
